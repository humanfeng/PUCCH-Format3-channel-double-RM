function c = pseudo(numbits,n_RNTI,N_cell_ID,n_s)
...
%                   set N_id=2;                                     
Nc = 1600;
c_init=(floor(n_s / 2) + 1) * (2 * N_cell_ID + 1) * 2^16 + n_RNTI;
...
% x2 = [x21 x22];                   % x2(1)=0,x2(2)=1;x2(n)=0,n=3,...,31;      
                                         %dec2bin(cinit,31)表示在最左边添零        
       %---------------------------dec2bin(10,31)=0000000000000000000000000001010
