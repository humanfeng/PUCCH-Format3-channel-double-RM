function r_PUCCH=dm_rs(N_UL_RB,symbol_out)
...
for i=1:length(a)
  for n = 1:M_RSsc
       w = 1; %orthogonal sequence w for PUCCH format 2b in normal cyclic perfix
        ...
        z1=1; %z1 = symbol_out(11);
      r_PUCCH(i,m1 * N_PUCCH_RS * M_RSsc + m * M_RSsc + n) = r_a(i,n); % PUCCH demodulation reference signal sequence rr with the length of 48
   end
  end
end
%r_PUCCH4*12矩阵
