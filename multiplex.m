function  z_out=multiplex(symbol_out,N_UL_RB)
...
for n = 1:10
 for i = 1:12
    z(N_PUCCHSeq * (n-1) + i) = d(n) * r_a(n,i); % d(0),...,d(9) is multiplied with a cyclically shifted length N_PUCCHSeq=12 sequence r_a with the length of 120
 end 
end
z_out=z;
size(z_out);